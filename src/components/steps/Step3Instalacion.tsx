                  ...
                  {TECHOS.map((techo) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.97 }}
                        className={`rounded-lg border px-3 py-2 text-left text-sm font-medium transition-colors duration-200 ${
                          selected
                            ? 'border-amber-400/70 bg-amber-50 text-amber-700'
                            : 'border-white/60 bg-white/60 text-slate-700 hover:border-sky-400/60 hover:text-sky-700'
                        }`}
                      >
                        {techo.label}
                      </motion.button>
